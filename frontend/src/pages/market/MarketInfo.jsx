    ...
    <>
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto p-4">
          <h1 className="text-3xl font-bold text-green-500 text-center mt-8">
            Market Information
          </h1>
          ...
          <div className="mt-10">
            ...
            <p className="mt-2 text-gray-600">
              Stay updated with the latest market trends and prices for your
              crops. Our data is sourced from reliable agricultural market
